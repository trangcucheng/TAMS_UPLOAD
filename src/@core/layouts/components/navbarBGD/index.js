      ...
      <div className='bookmark-wrapper d-flex align-items-center col-6'>
        ...
        <div className='navbar-brand' style={{
          ...
          <span className='brand-logo'>
            <img style={{ maxWidth: "36px", verticalAlign: "middle" }} src={themeConfig.app.appLogoImage} alt='logo' />
          </span>
          {/* <h2 className='brand-text mb-0' style={{ color: "#09A863" }}>{themeConfig.app.appName}</h2> */}
        </div>
        <h5 style={{ textTransform: "uppercase", margin: '0', color: "#09A863", fontWeight: 'bold' }}>Hệ thống quản lý nhà trường thông minh</h5>
