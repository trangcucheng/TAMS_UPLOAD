...
import { listAllUser, updateUser } from "../../../../../api/users"
...
const EditModal = ({ open, handleModal, listGroup, listStatus, getData, infoEdit, currentPage, rowsPerPage, setCurrentPage }) => {
  if (!infoEdit) return
