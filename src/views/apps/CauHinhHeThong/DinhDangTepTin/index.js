...
const DinhDangTepTin = () => {
    ...
    const handleDelete = (key) => {
        deleteGender({
            ...
            .then((res) => {
                MySwal.fire({
                    title: "Xóa định dạng tệp tin thành công",
                    icon: "success",
                    customClass: {
                        confirmButton: "btn btn-success",
                    },
            ...
            .catch((error) => {
                MySwal.fire({
                    title: "Xóa định dạng tệp tin thất bại",
                    icon: "error",
                    customClass: {
                        confirmButton: "btn btn-danger",
                    },
            ...
            >
                ...
                >
                    <h4 className="modal-title">{
                        action === 'Add' ? "Thêm mới định dạng tệp tin" : "Chỉnh sửa định dạng tệp tin"
                    } </h4>
                </ModalHeader>
                    ...
                    ><Row>
                            ...
                            <div className=' col col-12'>
                                <Form.Item style={{ marginBottom: '4px' }}
                                    ...
                                    label={
                                        <span>
                                            Tên định dạng tệp tin<span className="redColor">(*)</span>
                                        </span>
                                    }
                                    rules={[
                                        {
                                            required: true,
                                            message: 'Vui lòng nhập tên định dạng tệp tin'
                                        },
                                        {
                                ...
                                >
                                    <Input placeholder='Nhập tên định dạng tệp tin' />
                                </Form.Item>
                            </div>
                            <div className=' col col-12'>
                                <Form.Item style={{ marginBottom: '4px' }}
